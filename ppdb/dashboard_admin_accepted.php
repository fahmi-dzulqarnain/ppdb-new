...
<body>
    <?php
        ...
        $count = $mysqli->query("SELECT * FROM tbl_reg WHERE sekolah_daftar='$school' AND status_pendaf='dibayar'") or die($mysqli->error);
    ?>
    ...
    <div class="d-flex mb-3 bg-success" style="padding: 5px;">
        <div class="p-2 mr-auto bg-success" style="margin-top: 15px; margin-left: 10px; margin-right: 10px">
            <p style="color: white;">Pembayaran Disetujui <?php echo str_replace('-',' ', $school)?> (Jumlah <?php echo mysqli_num_rows($count) ?>)</p>
        </div>
        <div class="p-2">
                ...
                <table class="table">
                    ...
                    <tbody id="mainTable">
                        ...
                        <tr>
                            ...
                            <?php endif ?>
                            <td>
                                <a href="dashboard_admin_accepted.php?check=<?php echo $row['id']; ?>" class="btn btn-primary">Cek Bukti</a>
                            </td>
                            <td>
                                <a href="dashboard_admin_accepted.php?reject=<?php echo $row['id']; ?>" class="btn btn-danger">Tolak</a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
