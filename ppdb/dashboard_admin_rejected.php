...
<body>
    <?php
        ...
        $count = $mysqli->query("SELECT * FROM tbl_reg WHERE sekolah_daftar='$school' AND status_pendaf='bukti_bayar_ditolak'") or die($mysqli->error);
    ?>
    ...
    <div class="d-flex mb-3 bg-success" style="padding: 5px;">
        <div class="p-2 mr-auto bg-success" style="margin-top: 15px; margin-left: 10px; margin-right: 10px">
            <p style="color: white;">Pembayaran Ditolak <?php echo str_replace('-',' ', $school) ?> (Jumlah <?php echo mysqli_num_rows($count) ?>)</p>
        </div>
        <div class="p-2">
    ...
    <div>
        <?php
            $result = $mysqli->query("SELECT * FROM tbl_reg WHERE status_pendaf='bukti_bayar_ditolak' AND sekolah_daftar='$school' ORDER BY no_pendaftaran") or die($mysqli->error);
                ...
                <table class="table">
                    ...
                    <tbody id="mainTable">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="dashboard_admin_rejected.php?check=<?php echo $row['id']; ?>" class="btn btn-primary">Cek Bukti</a>
                                <a href="dashboard_admin_rejected.php?edit=<?php echo $row['id']; ?>" class="btn btn-success" style="margin-left: 12px;">Setujui</a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
