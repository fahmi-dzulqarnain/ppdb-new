...
<body>
    ...
    <div class="container">
        <div class="header-bar">
            <h3 class="header-text">Daftar TKIT</h3>
        </div>
        ...
        <div id="id01" class="w3-modal" style="z-index:99; min-height: 600px;">
            <div class="w3-modal-content w3-animate-zoom">
                <header class="w3-container w3-teal">
                    <h4 style="font-family: 'Quicksand', sans-serif;">Kuota Formulir Sudah Habis!</h4>
                </header>
                ...
                <div class="kurung">
                    <div><a href="../index.php#daftar" class="modal-content">Kembali Ke Halaman Utama</a> </div>
                </div>
            </div>
        </div>
</body>
