...
<body>
    ...
    <div class="container">
        <div class="header-bar">
            <h3 class="header-text">Daftar Ma'had Khadijah</h3>
        </div>
        ...
        <div class="forms-container">
            <form action="register.php" method="POST">
                ...
                <div class="flex-row">
                    ...
                    <div class="col-2">
                        <h4 class="quicksand">Data Calon Peserta</h4>
                        ...
                        <div class="kurung" style="margin-top: 5px;">
                            <div><input name="nama-siswa" type="text" placeholder="Nama Calon Peserta" class="input-text"> </div>
                            ...
                            <div><input name="asal-sekolah" type="text" placeholder="Asal Sekolah / Instansi / IRT" class="input-text"> </div>
                        </div>
